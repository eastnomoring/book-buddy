...
import { transcribeVoice, getConfig } from '../api/client'
import { chatStream, type ToolEvent } from '../platform'
...
function showInlineTyping(msg: UiMessage, idx: number): boolean {
